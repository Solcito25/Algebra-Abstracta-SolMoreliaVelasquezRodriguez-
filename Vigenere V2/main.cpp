...
int main()
{
    ...
    Vigenere emisor;
    string mensaje;
    mensaje=emisor.leermensaje();
    //emisor.cifrado(mensaje);
    //emisor.guardarcifrado(emisor.cifrado(mensaje));
    /*Vigenere receptor;
    receptor.descifrado(emisor.cifrado(emisor.leermensaje()));
    receptor.guardardescifrado(receptor.descifrado(emisor.cifrado(emisor.leermensaje())));
*/
