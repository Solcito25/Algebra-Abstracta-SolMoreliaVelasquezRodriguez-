...
int main()
{
   ...
   ///11.Dadas dos palabras, imprimir la que es lexicográficamente mayor.
    //cout<<str.LexiMayor("Algebra","Abstracta");
    ...
    ///b) Escriba un mensaje que descifre el mensaje codiﬁ cado usando 13 como la clave.*/
           // cout<<str.drot13(str.rot13("Algebra"))<<endl;
    ...
    getline(cin,palabra);
    str.Tokens(palabra);*/
    ///18.22Escriba un programa que introduzca una línea de texto y la imprima al revés. Use iteradores en su solución.

        //str.Reverse("Algebra Abstracta");
